...
(/** @lends <global> */function( $ ) {
	...
	function _fnDraw( oSettings )
	{
		...
		{
			/* Table is empty - create a row with an empty messageEnum in it */
	...
	function _fnInitialise ( oSettings )
	{
		 ...
		 * the table to look initialised for Ajax sourcing data (show 'loading' messageEnum possibly)
		 */
		if ( oSettings.oFeatures.bSort )
		{
			_fnSort( oSettings );
	...
	/**
	 * Log an error messageEnum
	 *  @param {object} oSettings dataTables settings object
	 *  @param {int} iLevel log error messageEnums, or display them to the user
	 *  @param {string} sMesg error messageEnum
	 *  @memberof DataTable#oApi
	 */
	...
	DataTable.defaults = {
		 ...
		 *           json[i][0] = '<a href="/messageEnum/'+json[i][0]+'>View messageEnum</a>';
		 *         }
		 *         return json;
		 *       }
		 *     }
		...
		"oLanguage": {
			 ...
			 * gathering the data, this messageEnum is shown in an empty row in the table to
